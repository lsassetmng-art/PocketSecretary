package com.lsam.pocketsecretary.ui.businesscard;
...
public class BusinessCardLinkActivity extends BaseActivity {
    ...
    protected String getHeaderTitle() {
        return getString(R.string.ps_screen_business_card);
    }
