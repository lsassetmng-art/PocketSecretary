...
public class OnboardingActivity extends AppCompatActivity {
    ...
    private void refreshState() {
        ...
        txtState.setText(
                "髫ｶ髮｣・ｽ・ｩ鬯ｮ・ｯ陷翫・繝ｻ髫ｲ・ｷ隹ｺ・ｺn" +
                "驛｢譎｢・ｽ・ｻ驛｢・ｧ繝ｻ・ｫ驛｢譎｢・ｽ・ｬ驛｢譎｢・ｽ・ｳ驛｢謨鳴驛｢譎｢・ｽ・ｼ(READ): " + (cal ? "OK" : "髫ｴ蟷｢・ｽ・ｪ鬮ｫ・ｪ繝ｻ・ｱ髯ｷ・ｿ繝ｻ・ｯ") + "\n" +
                "驛｢譎｢・ｽ・ｻ鬯ｨ・ｾ陞溘ｊ・｡繝ｻ " + (notif ? "OK" : "髫ｴ蟷｢・ｽ・ｪ鬮ｫ・ｪ繝ｻ・ｱ髯ｷ・ｿ繝ｻ・ｯ")
        );
    }
}
